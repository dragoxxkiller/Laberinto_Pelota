...
public class MovCamera1 : MonoBehaviour
{
    ...
    void Update()
    {
       ...
       // Vector3 targetPosition = new Vector3(playerPosition.transform.position.x, playerPosition.transform.position.y + 0.2f, playerPosition.transform.position.z - 0.3f);
        Vector3 targetPosition = new Vector3(playerPosition.transform.position.x , playerPosition.transform.position.y + 0.35f, playerPosition.transform.position.z -0.2f );
